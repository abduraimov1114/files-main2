      ...
      <div class="inner-container clearfix">
        ...
        <div class="logo-box">
          <div class="logo"><a href="/" title="Linoor - Digital Agency Template"><img
            src="/images/logoo.png" id="thm-logo" alt="Linoor - DIgital Agency HTML Template"
          ...
          <nav class="main-menu navbar-expand-md navbar-light">
            <div class="collapse navbar-collapse show clearfix">
              <ul class="navigation clearfix">
                ...
                <!-- <li class="dropdown"><a href="/team">Наши Преимущества</a>
                  <ul>
                    <li><nuxt-link to="/team">Our Team</nuxt-link></li>
                    <li><nuxt-link to="/testimonials">Прайс</nuxt-link></li>
                    <li><nuxt-link to="/faqs">FAQs</nuxt-link></li>
                    <li><nuxt-link to="/not-found">404 Page</nuxt-link></li>
                  </ul>
                </li> -->
                <!-- <li class="dropdown"><nuxt-link to="/services">Галерея</nuxt-link>
                  <ul>
                ...
                <li class="dropdown"><nuxt-link to="/portfolio">Портфолио</nuxt-link>
                  <ul>
                    <li><nuxt-link to="/portfolio">Портфолио</nuxt-link></li>
                    <li><nuxt-link to="/portfolio-single">Акустика</nuxt-link></li>
                    <li><nuxt-link to="/portfolio-single-2">Подиум</nuxt-link></li>
                  </ul>
                </li>
          ...
          <div class="link-box">
            <div class="call-us">
              <a class="link" href="tel:6668880000">
                ...
                <span class="sub-text span" >Call-centre</span>
                <span class="number">+998(91) 339 99 99</span>
              </a>
            </div>
          </div>
        </div>
